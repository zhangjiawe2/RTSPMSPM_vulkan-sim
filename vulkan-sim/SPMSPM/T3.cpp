...
/* ----------10.1 创建 Descriptor Set Layout ---------- */
    ...
    valueBinding.binding = 3; // GLSL binding = 2
    ...
    std::array<VkDescriptorSetLayoutBinding, 3> bindings = {tlasBinding, rayBinding, resultBinding};
 ...
 /* ----------10.3 创建 Descriptor Pool ---------- */
    ...
    std::array<VkDescriptorPoolSize, 2> poolSizes{{
        ...
        },
        {
            ...
            2   // ray buffer + result buffer + value/matrix buffer
        }
    }};
